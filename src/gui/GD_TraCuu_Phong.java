 ...
 * @author quang
 */
public class GD_TraCuu_Phong extends javax.swing.JFrame implements  I_TraCuu_QuanLi<Phong>{

    /**
     * Creates new form GD_TraCuu_Phong
     */
    ...
    private void initComponents() {
        ...
        pnlTop_title.setText("TRA CỨU PHÒNG");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GD_TraCuu_Phong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GD_TraCuu_Phong().setVisible(true);
            }
        });
    }
