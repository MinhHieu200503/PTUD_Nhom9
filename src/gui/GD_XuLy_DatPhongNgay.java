                ...
                public void actionPerformed(ActionEvent e) {
                        if (txt_SoDT.getSelectedItem() != null) {
                                ...
                                if(isKhDangCoHD(soDT)){
                                    ...
                                    for(ChitTietPhongHoaDon ct: lsCT)
                                    {
                                        String[] row = {ct.getPhong().getMaPhong(), ct.getPhong().getLoaiPhong().getTenLoaiPhong(), ct.getPhong().getSucChuaToiDa() +"", ct.getPhong().getGia()+""};
                                        model.addRow(row);
...
//            JOptionPane.showMessageDialog(null, "Bạn vừa chọn");
    ...
    public static void setTableData(String codePhong){
          ...
          Phong p = new Phong();
                   ...
                   String[] row = {ma, p.getLoaiPhong().getTenLoaiPhong(), p.getSucChuaToiDa()+"", p.getGia()+""};
