...
//        ta_moTa.setEditable(false);
    ...
    private void initComponents() {
        ...
        btn_them.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                GD_QuanLi_LoaiPhong.this.actionPerformed(evt);
            }
        });
    ...
    private void actionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actionPerformed
        ...
        if (o.equals(btn_them)) {
            ...
            if (btn_them.getText().equals("Thêm")) {
                ...
                for (LoaiPhong i : daolp.getAll(LoaiPhong.class)) {
                    dsid.add(i.getMaLoaiPhong());
                }
                createID(tf_id, dsid, "LP");
    ...
    private ArrayList<LoaiPhong> dslp = daolp.getAll(LoaiPhong.class);
