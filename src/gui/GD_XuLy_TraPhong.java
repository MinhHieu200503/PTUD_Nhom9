...
public class GD_XuLy_TraPhong extends javax.swing.JFrame {
    ...
    public ArrayList<entity.ThongTinPhongDangChon> loadThongTinChiTietHoaDon(){
        ...
        jLabel12.setText(String.format("%,.3f", tongDichVu) + "Đ");
        jLabel14.setText(String.format("%,.3f", tongTienPhong) + "Đ");
        jLabel18.setText(String.format("%,.3f", tongDichVu + tongTienPhong) + "Đ");
   ...
   private void initComponents() {
    ...
    public void setData(entity.Phong data){
        ...
        lb_Gia.setText("Giá: "+ String.valueOf(data.getGia()));
    }
