 ...
 * @author quang
 */
public class GD_TraCuu_LoaiPhong extends javax.swing.JFrame implements I_TraCuu_QuanLi<LoaiPhong>{

    /**
     * Creates new form GD_TraCuu_LoaiPhong
     */
    ...
    private void initComponents() {
        ...
        pnlTop_title.setText("TRA CỨU LOẠI PHÒNG");
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        ...
        if (row == -1) {
            ...
            new GD_QuanLi_LoaiPhong(row).setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GD_TraCuu_LoaiPhong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GD_TraCuu_LoaiPhong().setVisible(true);
            }
        });
    }
